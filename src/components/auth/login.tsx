...
export default function Login() {
    ...
    return (
        <div className=" bg-white shadow-md rounded-[13px] overflow-hidden">
            <h2 className="text-2xl text-center text-white bg-primary py-[18px] font-medium text-[24px]  mb-6">Login</h2>
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 p-6">
                ...
                <Button type="submit" className="w-full bg-primary py-6">Log In</Button>
            </form>
